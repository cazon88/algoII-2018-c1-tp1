...
private:
	struct rutina {
		Id nombre;
		std::vector<Instruccion> instrucciones; //cada rutina tiene un nombre y una secuencia de instrucciones.
	};

	std::vector<rutina> _rutinas; // El programa tiene 1 o varias rutinas.
};
